...
begin
  ...
  try
    ...
    SB.AppendFormat('한글: <b>%s 개</b><br>', [AddComma(TextInfo.HangulCount)]);
    SB.AppendFormat('(자음: <b>%s 개</b> / 모음: <b>%s 개</b>)<br><br>', [
      AddComma(TextInfo.HangulConsonantCount),
      AddComma(TextInfo.HangulVowelCount)
    ]);

    SB.AppendFormat('한자: <b>%s 개</b><br><br>', [AddComma(TextInfo.HanjaCharCount)]);

    SB.AppendFormat('영문: <b>%s 개</b><br>', [AddComma(TextInfo.AsciiLetterCount)]);
    SB.AppendFormat('(소문자: <b>%s 개</b> / 대문자: <b>%s 개</b>)<br><br>', [
      AddComma(TextInfo.AsciiLowerCount),
      AddComma(TextInfo.AsciiUpperCount)
    ]);

    SB.AppendFormat('숫자: <b>%s 개 </b><br>', [AddComma(TextInfo.AsciiDigitCount)]);
    SB.AppendFormat('특수 문자: <b>%s 개 </b><br><br>', [AddComma(TextInfo.SpecialCharCount)]);

    SB.AppendFormat('공백: <b>%s 개 </b><br>', [AddComma(TextInfo.SpaceCount + TextInfo.OtherSpaceCount)]);
    SB.AppendFormat('(스페이스: <b>%s 개</b> / 기타: <b>%s 개</b>)', [
